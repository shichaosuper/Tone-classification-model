...
def net():
    ...
    with cntk.layers.default_options():
        '''
        conv1 = cntk.layers.Convolution(my_rf_shape, activation = cntk.ops.relu, num_filters = 64, strides = my_strides, pad = True, bias = True, init = cntk.initializer.he_normal(), init_bias = cntk.initializer.he_normal())(input_var)
        ...
        conv2 = cntk.layers.Convolution(my_rf_shape, activation = cntk.ops.relu, num_filters = 72, strides = my_strides, pad = True, bias = True, init = cntk.initializer.he_normal(), init_bias = cntk.initializer.he_normal())(pool1)
        ...
        conv3 = cntk.layers.Convolution(my_rf_shape, activation = cntk.ops.relu, num_filters = 96, strides = my_strides, pad = True, bias = True, init = cntk.initializer.he_normal(), init_bias = cntk.initializer.he_normal())(pool2)
        ...
        '''
        fc1   = cntk.layers.Dense(96, activation = cntk.ops.relu, bias = True, init = cntk.initializer.he_normal(), init_bias = cntk.initializer.he_normal())(input_var)
        #sys.stderr.write("fc1" + str(fc1.shape) + '\n')
        drop1 = cntk.layers.Dropout(my_drop)(fc1)
        #sys.stderr.write("drop1" + str(drop1.shape) + '\n')
        fc2   = cntk.layers.Dense(72, activation = cntk.ops.relu, bias = True, init = cntk.initializer.he_normal(), init_bias = cntk.initializer.he_normal())(drop1)
        #sys.stderr.write("fc2" + str(fc2.shape) + '\n')
        drop2 = cntk.layers.Dropout(my_drop)(fc2)
        #sys.stderr.write("drop2" + str(drop2.shape) + '\n')
        fc3   = cntk.layers.Dense(64, activation = cntk.ops.relu, bias = True, init = cntk.initializer.he_normal(), init_bias = cntk.initializer.he_normal())(drop2)
